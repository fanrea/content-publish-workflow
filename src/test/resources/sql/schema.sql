-- Test-only embedded schema for H2 in MySQL compatibility mode.
-- Keep this file aligned with src/main/resources/sql/schema.sql while avoiding
-- MySQL inline index declarations that H2 rejects inside CREATE TABLE.
