...
public final class ReviewRecordMapper {
    ...
    public static ReviewRecord toDomain(ReviewRecordEntity e) {
        if (e == null) {
            return null;
        }
    ...
    public static ReviewRecordEntity toEntity(ReviewRecord d) {
        if (d == null) {
            return null;
        }
        ReviewRecordEntity e = new ReviewRecordEntity();
        e.setId(d.getId());
