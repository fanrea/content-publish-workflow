 ...
 *
 * <p>Mirrors the official executor property structure so this service can register itself in
 * XXL-Job admin without coupling business code to the config layer.</p>
 */
